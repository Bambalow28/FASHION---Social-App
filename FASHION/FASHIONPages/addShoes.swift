...
class addShoes: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    
    @IBOutlet weak var lblShoeName: UITextField!
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any])
    {
        ...
        storage.child("images").child(lblShoeName.text!).putData(imageData, metadata: nil, completion: { _, error in
                ...
                self.storage.child("images").child(self.lblShoeName.text!).downloadURL(completion: { url, error in
    ...
    @IBAction func addClicked(_ sender: Any)
    {
        ...
        else
        {
            ...
            {
                //Firebase Saving
                self.ref?.child("users").child(userID!).child("Items").child(self.lblShoeName.text!).setValue([
